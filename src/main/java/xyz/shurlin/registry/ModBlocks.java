...
public class ModBlocks {
    ...
    public static final Block PLANT_IRON_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block PLANT_IRON_BLOCK = new Block(FabricBlockSettings.copy(Blocks.IRON_BLOCK));
    public static final Block PLANT_GOLD_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block PLANT_GOLD_BLOCK = new Block(FabricBlockSettings.copy(Blocks.GOLD_BLOCK));
    public static final Block PLANT_JADE_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block PLANT_JADE_BLOCK = new Block(FabricBlockSettings.copy(Blocks.DIAMOND_BLOCK));
    public static final Block SMALL_BUD = new SmallBudBlock(BlockSettings.PLANT);
    public static final Block PLATYCODON_GRANDIFLORUS = new PlatycodonGrandiflorusBlock(StatusEffects.REGENERATION, 1314, BlockSettings.PLANT);
    public static final Block PEAR_LOG = new PillarBlock(BlockSettings.LOG);
    public static final Block PEAR_PLANKS = new Block(BlockSettings.PLANKS);
    public static final Block PEAR_LEAVES = new LeavesBlock(BlockSettings.LEAVES);
    public static final Block PEAR_RIPE_LEAVES = new LeavesBlock(BlockSettings.LEAVES.strength(0.3f, 0.3f));
    public static final Block PEAR_DOOR = new BasicDoorBlock();
    public static final Block PHOENIX_LOG = new PillarBlock(BlockSettings.LOG);
    public static final Block PHOENIX_PLANKS = new Block(BlockSettings.PLANKS);
    public static final Block PHOENIX_LEAVES = new LeavesBlock(BlockSettings.LEAVES);
    public static final Block BREAKER_BLOCK = new BreakerBlock(BlockSettings.WORKER);
    public static final Block COLLECTOR_BLOCK = new CollectorBlock(BlockSettings.WORKER);
    public static final Block CONCENTRATOR_BLOCK = new ConcentratorBlock(BlockSettings.WORKER);
    public static final Block EXTRACTOR_BLOCK = new ExtractorBlock(BlockSettings.WORKER);
    public static final Block HOLY_PEAR_ALTAR = new HolyPearAltarBlock(FabricBlockSettings.copy(Blocks.OBSIDIAN));
    public static final Block STARRY_ALTAR = new StarryAltarBlock(FabricBlockSettings.of(Material.STONE).strength(10.0f).luminance(12));
    ...
    public static final Block LLANDUDNO = new Block(BlockSettings.LLANDUDNO);
    public static final Block PEAR_SAPLING = new BasicSaplingBlock(ModConfiguredFeatures.PEAR_TREE, BlockSettings.PLANT);
    public static final Block PHOENIX_SAPLING = new BasicSaplingBlock(ModConfiguredFeatures.PHOENIX_TREE, BlockSettings.PLANT);
    public static final Block DEAD_LEAVE_CORAL = new DeadLeaveCoralBlock(BlockSettings.DEAD_CORAL);
    public static final Block LEAVE_CORAL = new LeaveCoralBlock(DEAD_LEAVE_CORAL, BlockSettings.CORAL);
    public static final Block DEAD_LEAVE_CORAL_FAN = new DeadLeaveCoralFanBlock(BlockSettings.DEAD_CORAL);
    public static final Block LEAVE_CORAL_FAN = new LeaveCoralFanBlock(DEAD_LEAVE_CORAL_FAN, BlockSettings.CORAL);
    public static final Block DEAD_LEAVE_CORAL_WALL_FAN = new DeadLeaveCoralWallFanBlock(BlockSettings.DEAD_CORAL.dropsLike(DEAD_LEAVE_CORAL_FAN));
    public static final Block LEAVE_CORAL_WALL_FAN = new LeaveCoralWallFanBlock(DEAD_LEAVE_CORAL_WALL_FAN, BlockSettings.CORAL.dropsLike(LEAVE_CORAL_FAN));
    public static final Block DEAD_LEAVE_CORAL_BLOCK = new Block(BlockSettings.DEAD_CORAL_BLOCK);
    public static final Block LEAVE_CORAL_BLOCK = new LeaveCoralBlockBlock(DEAD_LEAVE_CORAL_BLOCK, BlockSettings.CORAL_BLOCK);
    public static final Block HOT_FIRE_STONE = new Block(BlockSettings.STONE);
    public static final Block HOT_FIRE_DIRT = new Block(BlockSettings.DIRT);
    public static final Block TENUOUS_METAL_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_WOOD_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_WATER_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_FIRE_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_EARTH_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_WIND_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_LIGHT_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_DARKNESS_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_POISON_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_LIGHTNING_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
    public static final Block TENUOUS_ICE_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE_IN_ICE);
    public static final Block TENUOUS_TIME_SPACE_SPIRIT_ORE_BLOCK = new SpiritOreBlock(BlockSettings.ORE);
